const dict = {
  ...
  mask: { alias: 'ma', type: 'string' },
  'mask-type': { alias: 'mat', type: 'string' },
  'text-combine-upright': { alias: 'tcu', type: 'string' },
  'perspective-origin': { alias: 'pspco', type: ['number', 'string'] },
  quotes: { alias: 'q', type: 'string' },
  'scroll-behavior': { alias: 'sb', type: 'string' },
  'tab-size': { alias: 'ts', type: 'string' },
  isolation: { alias: 'iso', type: 'string' },
  'box-decoration-break': { alias: 'bxdb', type: 'string' },
  'break-after': { alias: 'ba', type: 'string' },
  'break-before': { alias: 'bb', type: 'string' },
  'break-inside': { alias: 'bi', type: 'string' },
  'caret-color': { alias: 'cc', type: 'string' },
  direction: { alias: 'dir', type: 'string' },
};
